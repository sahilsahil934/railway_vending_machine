...
def main():
    ...
    db.execute("CREATE TABLE all_tickets (id SERIAL PRIMARY KEY,user_id INTEGER, from_city VARCHAR NOT NULL, to_city VARCHAR NOT NULL, passengers INTEGER, cost FLOAT NOT NULL, date VARCHAR NOT NULL, time VARCHAR NOT NULL, payment INTEGER, returned INTEGER)")
